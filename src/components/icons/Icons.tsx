// commit 05/29 (Henry): feat(common) - cria biblioteca de ícones SVG reutilizáveis (sem dependências externas)
interface IconProps {
  className?: string
}
...
export function BotIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <circle cx="12" cy="12" r="3" />
      <path d="M3 12a9 9 0 0 1 9-9v0a9 9 0 0 1 9 9v0a9 9 0 0 1-9 9v0a9 9 0 0 1-9-9z" />
    </svg>
  )
}
